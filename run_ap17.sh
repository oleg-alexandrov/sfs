...
lola2=ap17_ba_stereo_dabkj2/run-trans_source-DEM.tif
>>  di $lola2 ap17_ba_stereo_dabkj2/run-before-sfs-tile-0-crop.tif
  Minimum=0.003, Maximum=2.236, Mean=0.752, StdDev=0.445

oalexan1@mfe1:~/projects/sfs
>>>  di $lola2 ap17_ba_stereo_dabkj2/run-after-sfs-tile-0-crop.tif
...
reg=0.06; level=0; ref=0; for th in 1000 2000 4000; do 
...
for f in $(llt sfs_db*crop19* |g -v txt|pc 0); do h=$(ls -altrd $f/*DEM*tif | grep -i -v hill | tail -n 1 | pc 0); echo $h; di $lola2 $h; done
